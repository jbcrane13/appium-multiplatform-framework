...
class iOSDeployment:
    ...
    def copy_templates(self, automation_project_path: Path) -> None:
        ...
        self.utils.copy_template(
            'test_diagnostic.py.template',
            automation_project_path / 'tests' / 'ios' / 'test_diagnostic.py',
            replacements
        )

        # Debug utilities
        self.utils.copy_template(
            'debug_helpers.py.template',
            automation_project_path / 'utils' / 'debug_helpers.py',
            replacements
        )
        ...
        self.utils.copy_template(
            ...
            automation_project_path / 'TROUBLESHOOTING.md',
            replacements
        )
...
"""
    ...
    def print_next_steps(self, automation_project_path: Path) -> None:
        ...
        print(f"4. Run diagnostic tests to understand app structure:")
        print(f"   pytest tests/ios/test_diagnostic.py -v -s")
        print(f"   - Dumps page source to debug/ folder")
        print(f"   - Shows tab bar structure and available elements\n")

        print(f"5. Update page object locators:")
        print(f"   - Edit pages/ios/home_page.py")
        print(f"   - Use Appium Inspector or diagnostic tests to find IDs")
        print(f"   - See TROUBLESHOOTING.md for help\n")

        print(f"6. Check documentation:")
        print(f"   - TROUBLESHOOTING.md - Diagnostic tools and common solutions")
        print(f"   - CLAUDE.md - Development guidelines for robust testing\n")

        print(f"7. Run smoke tests:")
        print(f"   pytest tests/ios/ -m smoke -v\n")

        print(f"8. Run all iOS tests:")
